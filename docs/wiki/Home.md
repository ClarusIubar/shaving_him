...
![Version](https://img.shields.io/badge/version-v1.0.5--quality-brightgreen?style=for-the-badge)
...
![Branch Coverage](https://img.shields.io/badge/branch-91.32%25-green?style=for-the-badge)
...
- **Node.js 공식 테스트 통과율**: **100% (34 / 34 Cases PASS)**
- **라인 커버리지 (Line %)**: **100.00%** (16개 전체 소스 파일)
- **함수 커버리지 (Funcs %)**: **100.00%** (16개 전체 소스 파일)
- **브랜치 커버리지 (Branch %)**: **91.32%** (도메인/어댑터/포트/UI 전 계층 통과)
